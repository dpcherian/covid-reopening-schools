...
void run(double Tpars[][4], int tf, bool lock_homes, bool quarantine_when_sample_taken, double begin_at, double test_frac, double start_vacc, double dvr, double unlockSchoolsAt, int iter){
